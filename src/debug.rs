...
impl fmt::Debug for NetworkData {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("NetworkData")
            .field("income", &self.get_income())
            .field("total income", &self.get_total_income())
            .field("outcome", &self.get_outcome())
            .field("total outcome", &self.get_total_outcome())
            .field("packets income", &self.get_packets_income())
            .field("total packets income", &self.get_total_packets_income())
            .field("packets outcome", &self.get_packets_outcome())
            .field("total packets outcome", &self.get_total_packets_outcome())
            .field("errors income", &self.get_errors_income())
            .field("total errors income", &self.get_total_errors_income())
            .field("errors outcome", &self.get_errors_outcome())
            .field("total errors outcome", &self.get_total_errors_outcome())
            .finish()
    }
}
